...
<head>
    ...
    <title>Ovos Ebenezer — Criar Conta</title>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    body {
        background: var(--bg);
        background-image: radial-gradient(rgba(249,115,22,.055) 1px, transparent 1px);
    ...
    .btn-submit:hover { transform: translateY(-2px); box-shadow: 0 10px 28px rgba(249,115,22,.42); }
    ...
    .btn-switch {
        ...
        padding: 10px 26px;
        border: 2px solid rgba(249,115,22,.45); border-radius: 50px;
        background: rgba(249,115,22,.08); color: rgba(255,255,255,.82);
        font-family: 'Sora', sans-serif; font-size: .79rem; font-weight: 700;
        cursor: pointer; transition: all .22s ease; letter-spacing: .01em;
    }
    .btn-switch:hover {
        background: rgba(249,115,22,.18); border-color: var(--brand); color: #fff;
...
<div class="auth-card" id="auth-card">
    ...
    <div class="brand-panel" id="brand-panel">
        ...
        <div class="bc" id="bc-login">
            ...
            <p class="brand-desc">
                Registre-se para ter acesso a todas as funcionalidades do sistema Ovos Ebenezer.
            </p>
        ...
        <div class="bc" id="bc-register">
            ...
            <div class="brand-rule"></div>
            <p class="brand-desc">
                Entre com suas credenciais e acesse o painel de gestão Ovos Ebenezer.
            </p>
