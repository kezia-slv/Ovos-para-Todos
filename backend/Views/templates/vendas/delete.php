...
<div class="container mt-4">
    ...
    <div class="card shadow-sm border-danger">
        ...
        <div class="card-body text-center py-5">
            ...
            <h4 class="mb-2">Tem certeza que deseja excluir a venda <strong>#<?= htmlspecialchars($id_vendas) ?></strong>?</h4>
            <p class="text-muted mb-4">O registro não será removido permanentemente, mas ficará marcado como inativo.</p>

            <form action="/vendas/excluir" method="POST" class="d-inline">
                <input type="hidden" name="id_vendas" value="<?= htmlspecialchars($id_vendas) ?>">
