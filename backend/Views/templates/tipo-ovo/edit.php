...
<div class="container mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2>Editar Tipo de Ovo #<?= htmlspecialchars($tipo['id_tipo_ovo']) ?></h2>
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form action="/tipo-ovo/atualizar" method="POST">

                <!-- Campo hidden com o ID -->
                <input type="hidden" name="id_tipo_ovo" value="<?= htmlspecialchars($tipo['id_tipo_ovo']) ?>">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nome_tipo_ovo" id="nome_tipo_ovo" class="form-control"
                            value="<?= htmlspecialchars($tipo['nome_tipo_ovo']) ?>" required>
                    </div>
