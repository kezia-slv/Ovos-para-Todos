...
<div class="container mt-4">
    ...
    <div class="card shadow-sm border-danger">
        ...
        <div class="card-body text-center py-5">
            ...
            <i class="fas fa-boxes fa-4x text-danger mb-3"></i>
            <h4 class="mb-2">Tem certeza que deseja excluir o registro de estoque <strong>#<?= htmlspecialchars($id_estoque) ?></strong>?</h4>
            <p class="text-muted mb-4">O registro não será removido permanentemente, mas ficará marcado como inativo.</p>

            <form action="/estoque/excluir" method="POST" class="d-inline">
